...
public class CategorieQuestionController {
    ...
    public ResponseEntity<CategorieQuestionDto> addCategorieQuestion(@RequestBody final CategorieQuestionDto categorieCategorieQuestionDto){
        CategorieQuestion categorieCategorieQuestion = categorieQuestionService.addCategorieQuestion(CategorieQuestion.from(categorieCategorieQuestionDto));
    ...
    public ResponseEntity<CategorieQuestionDto> editCategorieQuestion(@PathVariable final Integer id,
        ...
        CategorieQuestion editedCategorieQuestion = categorieQuestionService.editCategorieQuestion(id, CategorieQuestion.from(categorieCategorieQuestionDto));
