...
import fr.capeb.backend.riskevaluator.projection.MetierScoreResponse;
...
public class MetierController {
	...
	public ResponseEntity<List<MetierScoreResponse>> getScoreParMetier(
